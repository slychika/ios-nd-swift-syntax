...
let yourSentence = "The \(nounArray[4]) jumped over the \(nounArray[8])"
let yourSillySentence = "How come the \(nounArray[index1]) loves \(nounArray[index2])?"
//: ### Exercise 2
...
let didYouKnowShout = "HEY! " + didYouKnowString.uppercased()
//: ### Exercise 3
//: How many characters are in this string? 
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
let length = howManyCharacters.characters.count
//: ### Exercise 4
